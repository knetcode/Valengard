...
- A character that has actively acted against their deity is classified as a **Scorn**. A Scorn can only devote their faith to a deity an opposing pantheon or the Purple Pantheon. Scorn not only lose all their previous boons, but also suffer a -2 to their highest ability stat until they have re-dedicated their faith to another deity.
